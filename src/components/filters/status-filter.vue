  ...
  <div class="decor-parent">
    ...
    <div class="frame-parent3">
      <div class="fields-parent">
        ...
        <ul>
          <li>
            <label class="label">Статус транзакции:</label>
            <ul class="inner-list">
              <li class="list-item">
                Внесенная сумма
                <catos-checkbox></catos-checkbox>
              ...
              <li class="list-item_switch list-item">
                Показывать все
      ...
      <div class="fieldsregistration-options1">
        ...
        <router-link class="link_back" to="" @click="$router.go(-1)">
          Назад
        </router-link>
      </div>
    </div>
