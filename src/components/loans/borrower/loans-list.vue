<template>
  <div class="pull-stats">
    <div
      :class="
        variant === 'sold'
          ? 'pull-stats-child_sold pull-stats-child'
          : variant === 'repaid'
          ? 'pull-stats-child_repaid pull-stats-child'
          : 'pull-stats-child'
      "
    ></div>
    <div class="filtr">
      <div class="frame">
        <div class="div9">Займ #1657946</div>
      </div>
    </div>
      ...
      <div class="frame-group">
          ...
          <div class="buttons-tabs-parent">
            ...
            <div class="frame-div">
              ...
              <div class="percent-parent">
                ...
                <div class="div11">30 дней = 30%</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="frame-parent2">
          <div class="frame-parent3">
            <div class="roi-wrapper">
              <div class="roi">Займ:</div>
            </div>
            <div class="ton-wrapper">
              <div class="div16">13 000 TON</div>
            </div>
          </div>
          ...
          <div class="frame-parent3">
            <div class="roi-wrapper">
              <div class="roi">Начисленные проценты:</div>
            </div>
            <div class="ton-wrapper">
              <div class="div16">512 TON</div>
            </div>
          </div>
          <div class="line-div"></div>
          <div class="frame-parent3">
            <div class="roi-wrapper">
              <div class="roi">
                {{
                  variant === "active" ? "Беспроцентный период" : "На строк"
                }}:
              </div>
            </div>
            <div v-if="variant === 'active'" class="ton-wrapper">
              <div class="div16">до 05.02.22, 16:00</div>
              <div class="div16_close div16">(завершен)</div>
            </div>
            <div v-else class="ton-wrapper">
          ...
          <div class="frame-parent3">
            ...
            <div v-if="variant === 'active'" class="ton-wrapper">
              <div class="div16">13 512 TON</div>
            </div>
            <div v-else class="ton-wrapper">
              <div class="div16">до 05.02.22, 16:00</div>
              <div class="div16_close div16">(завершен)</div>
          ...
          <div v-if="variant === 'sold'" class="line-div"></div>
          <div v-if="variant === 'sold'" class="frame-parent3">
            <div class="roi-wrapper">
              <div class="roi">Сумма к возвращению</div>
            </div>
            <div class="ton-wrapper">
              <div class="div16">13 512 TON</div>
            </div>
          </div>
          <div v-if="variant === 'repaid'" class="line-div"></div>
          <div v-if="variant === 'repaid'" class="frame-parent3">
            <div class="roi-wrapper">
              <div class="roi">Сумма погашения</div>
            </div>
            <div class="ton-wrapper">
              <div class="div16">13 512 TON</div>
            </div>
          ...
          <div v-if="variant === 'repaid'" class="frame-parent3">
            <div class="roi-wrapper">
              <div class="roi">Дата погашения</div>
            </div>
            <div class="ton-wrapper">
              <div class="div16">13.02.22 в 19.32</div>
            </div>
          </div>
        </div>
        <div v-if="variant === 'active'" class="percent-group">
          <img
            class="percent-icon1"
            alt=""
          ...
          <div v-if="variant === 'active'" class="div24">
            Вернуть не позднее: до 13.02.22, 16:00 <br />
            <div class="div24_status div24">(осталось 29 дней)</div>
          </div>
        </div>
        <div v-if="variant === 'active'" class="percent-group">
          ...
          <div class="div24">
            Проценты начисляются с <span>12 апреля 2023 года</span>
          </div>
        </div>
        <div v-if="variant === 'sold'" class="percent-group">
          <img
            class="percent-icon1"
            alt=""
            src="@/assets/images/alerttriangle-white.svg"
          ...
          <div class="div24">
            Вернуть не позднее: до 13.02.22, 16:00 <br />
            <div class="div24_status_overdue div24_status div24">
              (займ просрочен)
            </div>
          </div>
        </div>
        <div
          v-if="variant === 'sold'"
          class="percent-group_overdue percent-group"
        >
          <div class="percent-group_content">
            <img
              class="percent-icon1_danger percent-icon1"
              alt=""
              src="@/assets/images/alerttriangle-red.svg"
            />
            <h4>Займ продан</h4>
          </div>
          <div class="div24_sold div24">
            Ваш долг был продан <span> коллектору 000 Обязательства</span>. С
            вами свяжутся представители этой организации для обсуждения вопросов
            возврата долга
          </div>
        </div>
      </div>
      <div class="des-and-bbn">
        <div class="text-and-button-parent">
          <div class="text-and-button">
            ...
            >
              <div class="text2" @click="toScan">
                <div>Погасить досрочно</div>
              </div>
            </div>
            <div
              class="buttons-tabs2_more buttons-tabs2"
  ...
  <div
    v-if="variant === 'active'"
    class="pull-stats_overdue pull-stats"
    :class="variant !== 'active' ? 'pull-stats_1' : ''"
  >
    <div
      :class="
        variant !== 'active'
          ? 'pull-stats-child_1 pull-stats-child'
          : 'pull-stats-child'
      "
    ></div>
    <div class="filtr">
      <div class="frame">
        <div class="div9">Займ №1223</div>
      </div>
    </div>
    <div class="pull-stats1">
      <div class="frame-group">
        ...
        <div class="frame-parent2">
          ...
          <div class="frame-parent3">
            ...
            <div class="ton-wrapper">
              <div class="div16">до 05.02.22, 16:00</div>
              <div class="div16_overdue div16">(займ просрочен)</div>
            </div>
          </div>
          <div class="line-div"></div>
          <div class="frame-parent3">
        ...
        <div class="text-and-button-parent">
          <div class="text-and-button">
            ...
            <div
              ...
              id="buttonsTabsContainer3"
            >
              <div class="text2" @click="toProlong">
                <div>Пролонгировать</div>
              </div>
            </div>
...
const toScan = () => {
  router.push({
    ...
    state: {
      ...
      subTitle:
        "Scan the QR code and pay 13 512 TON with Tonkeeper using  EQB5...dzE1hа44",
      routerName: "loans-borrower",
      actionTitle: "Repay the loan",
