  ...
  <div class="iphone-13-13-form-registr">
    ...
    <div class="form-registration-46">
      <div class="div8">
          ...
          <div class="frame-group">
              ...
              <div class="frame-wrapper">
                <div class="fieldsinputchoise">
                  ...
                  <input-data
                    ...
                    :right="true"
                    v-model:model-value="userDataStore.userDTO.passport.country"
                  >
            ...
            <div class="frame-container">
              <div class="frame-div">
                ...
                <input-data
                  ...
                  @update:model-value="ev => userDataStore.userDTO.passport.number = ev"
                >
                  <template v-slot:right-icon>
                    <img src="@/assets/images/iconseditoutline-black.svg" />
                  </template>
              ...
              <div class="frame-div">
                ...
                <div class="fields-password-and-mail-container">
                  <input-data
                    ...
                    v-model:model-value="
                      userDataStore.userDTO.passport.issue_date
                    "
                  ></input-data>
            ...
            <div class="fieldsinputchoise">
              ...
              <catos-textarea
                ...
                v-model:model-value="
                  userDataStore.userDTO.passport.issuing_organization
                "
                @selected="
                  ev =>
                    (userDataStore.userDTO.passport.issuing_organization = ev)
                "
              ></catos-textarea>
            </div>
          </div>
        ...
        <div class="div17">
            ...
            <div class="fieldsinput-parent">
              <div class="fieldsinput">
                ...
                <input-data
                  ...
                  :right="true"
                  v-model:model-value="userDataStore.userDTO.passport.name"
                >
                  <template v-slot:right-icon>
                    <img src="@/assets/images/iconseditoutline-black.svg" />
                  </template>
              ...
              <div class="fieldsinput">
                ...
                <input-data
                  ...
                  :right="true"
                  v-model:model-value="userDataStore.userDTO.passport.surname"
                >
                  <template v-slot:right-icon>
                    <img src="@/assets/images/iconseditoutline-black.svg" />
                  </template>
              ...
              <div class="fieldsinput">
                ...
                <input-data
                  ...
                  :right="true"
                  v-model:model-value="userDataStore.userDTO.passport.middleName"
                >
                  <template v-slot:right-icon>
                    <img src="@/assets/images/iconseditoutline-black.svg" />
                  </template>
              ...
              <div class="fieldsinputchoise">
                <div class="div24">
                  <span class="span17">Национальность</span>
                ...
                <input-data
                  ...
                  :right="true"
                  @update:model-value="
                    ev => (userDataStore.userDTO.nationality = ev)
                  "
                >
                  <template v-slot:right-icon>
                    <img src="@/assets/images/iconseditoutline-black.svg" />
              ...
              <div class="fieldsinput">
                ...
                <input-data
                  ...
                  :right="true"
                  @update:model-value="ev => userDataStore.userDTO.passport"
                >
                  <template v-slot:right-icon>
                    <img src="@/assets/images/iconseditoutline-black.svg" />
                  </template>
          ...
          <div class="wrapper2">
            <div class="div30">
              <span>Данные представителя организации </span>
              <span class="span2">*</span>
            </div>
          </div>
        </div>
      ...
      <div class="header">
        ...
        <div class="parent9">
          <div class="div31">
            <p class="p">Заполняйте поля внимательно</p>
            <p class="p">и настоящими данными</p>
          </div>
          <div class="div32">
            <p class="p">Данные будут использоваться</p>
            <p class="p">для заключения пользовательского соглашения</p>
          </div>
        </div>
      </div>
      <div class="registration-options">
        ...
        <div class="fieldsinputchoise-parent">
          <div class="text2">
            <div class="div22">
              <span class="span8">
                <span class="span17">Область, край </span>
                <span class="span15"> </span>
              </span>
              <span class="span15">
                <span>
            ...
            <catos-select
              ...
              :options="options"
              :value="
                userDataStore.userDTO.passport.registration_address.region
              "
              :optionWidth="77"
              :style="{ width: '100%' }"
              @selected="
          ...
          <div class="fieldsinputchoise3">
            ...
            <catos-select
              ...
              @selected="
                ev =>
                  (userDataStore.userDTO.passport.registration_address.city =
                    ev)
              "
            ></catos-select>
          </div>
          <div class="fieldsinputchoise3">
            ...
            <catos-select
              ...
              :options="options"
              :value="
                userDataStore.userDTO.passport.registration_address.neighborhood
              "
              :optionWidth="77"
              :style="{ width: '100%' }"
              @selected="
          ...
          <div class="text2">
            ...
            <input-data
              ...
              @update:model-value="
                ev =>
                  (userDataStore.userDTO.passport.registration_address.street =
                    ev)
              "
            >
              <template v-slot:right-icon>
        ...
        <div class="frame-parent2">
          <div class="frame-parent3">
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.registration_address.house =
                      ev)
                "
              ></input-data>
            </div>
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.registration_address.housing =
                      ev)
                "
              ></input-data>
            </div>
          ...
          <div class="frame-parent3">
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.registration_address.building =
                      ev)
                "
              ></input-data>
            </div>
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.registration_address.apartment =
                      ev)
                "
              ></input-data>
            </div>
          ...
          <div class="parent11">
            ...
            <input-data
              ...
              @update:model-value="
                ev =>
                  (userDataStore.userDTO.passport.registration_address.index =
                    ev)
              "
            ></input-data>
          </div>
      ...
      <div class="registration-options1">
        ...
        <div class="text-and-fill">
          <div class="div30">
            <span>Адресс фактического места проживания</span>
            <span class="span2"> *</span>
          </div>
        </div>
        <div class="fieldsinputchoise-parent">
          ...
          <div class="fieldsinputchoise">
            ...
            <catos-select
              ...
              @selected="
                ev =>
                  (userDataStore.userDTO.passport.living_address.region = ev)
              "
            ></catos-select>
          </div>
          <div class="fieldsinput">
            ...
            <catos-select
              ...
              :options="options"
              :value="
                userDataStore.userDTO.passport.living_address.neighborhood
              "
              :optionWidth="77"
              :style="{ width: '100%' }"
              @selected="
          ...
          <div class="fieldsinputchoise3">
            ...
            <catos-select
              ...
              :style="{ width: '100%' }"
              @selected="
                ev => (userDataStore.userDTO.passport.living_address.city = ev)
              "
            ></catos-select>
          </div>
          <div class="text2">
            ...
            <input-data
              ...
              @update:model-value="
                ev =>
                  (userDataStore.userDTO.passport.living_address.street = ev)
              "
            >
              <template v-slot:right-icon>
                <img src="@/assets/images/iconseditoutline-black.svg" />
        ...
        <div class="frame-parent5">
          <div class="frame-parent3">
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.living_address.house = ev)
                "
              ></input-data>
            </div>
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.living_address.housing = ev)
                "
              ></input-data>
            </div>
          </div>
          <div class="frame-parent3">
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.living_address.building =
                      ev)
                "
              ></input-data>
            </div>
            <div class="parent11">
              ...
              <input-data
                ...
                @update:model-value="
                  ev =>
                    (userDataStore.userDTO.passport.living_address.apartment =
                      ev)
                "
              ></input-data>
            </div>
          ...
          <div class="parent11">
            ...
            <input-data
              ...
              :style="{ width: '100%' }"
              @update:model-value="
                ev => (userDataStore.userDTO.passport.living_address.index = ev)
              "
            ></input-data>
          </div>
        </div>
    ...
    <div class="header1">
      <div class="page-title-parent">
        <b class="page-title1">Анкета представителя</b>
      </div>
    </div>
    <div class="slidersteps">
      <div class="loader6"></div>
      <div class="numbers">
        <div class="div79">из</div>
        <div class="div79">7</div>
      </div>
      <div class="steps">
        <div class="div69">4 шаг</div>
      </div>
    </div>
    <router-link class="buttonback" to="" @click="$router.go(-1)">
      <div class="div82">Назад</div>
...
const passportNumberString = reactive({
  value:
    userDataStore.userDTO.passport.number === 0
      ? ""
      : userDataStore.userDTO.passport.number.toString(),
});
</script>
