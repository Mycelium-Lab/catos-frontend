<template>
  <div v-if="!isManagement" class="pull-stats">
    ...
    <div class="pull-stats1">
      <div class="frame-group">
        ...
        <div
          class="frame-parent1"
          :class="variant === 'my' ? 'frame-parent1_my' : ''"
        >
          <div v-if="variant === 'all'" class="roi-wrapper">
...
import liquidityManagement from "./liquidity/liquidity-management.vue";
