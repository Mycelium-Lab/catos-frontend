<template>
  <default-desktop-admin back>
    <template v-slot:title> API запросы </template>
    ...
    <template v-slot:list>
      <ul>
        <li v-for="n in 6" :key="n">
          <api-admin-table :variant="currentWindow" :key="currentWindow">
          </api-admin-table>
        </li>
      </ul>
    </template>
...
import apiAdminTable from "@/components/admin/desktop/bids-admin-table.vue";
