  ...
  <div class="iphone-13-13-">
    ...
    <div class="div27">
      <div class="description">
        <div class="div28">Сортировать по:</div>
      </div>
      <div class="div29" id="text24">Закрыть</div>
      <div class="swipe-down"></div>
      <div class="group">
        <div class="div30">Выбор сортировки:</div>
        <div class="tags-brand">
          <div class="tag">
            <div class="div31">Создать</div>
          </div>
          <div class="tag1">
            <div class="div31">Сортировка 1</div>
          </div>
          <div class="tag1">
            <div class="div31">Сортировка 1</div>
          </div>
      ...
      <div class="parent1">
        <div class="div34">Сбросить параметры</div>
      ...
      <div class="frame-parent11">
        <div class="parent2">
          <div class="div35">По одобренному кредиту:</div>
          <div class="frame-parent12">
            <div class="radiobutton-parent">
              <div class="div36">По убыванию</div>
            </div>
            <div class="radiobutton-parent">
              <div class="div36">По возрастанию</div>
            </div>
          </div>
        </div>
        <div class="parent2">
          <div class="div35">Дневной ставке:</div>
          <div class="frame-parent12">
            <div class="radiobutton-parent">
              <div class="div36">По убыванию</div>
            </div>
        ...
        <div class="parent2">
          <div class="div35">Беспроцентный периоду:</div>
          <div class="frame-parent12">
            <div class="radiobutton-parent">
              <div class="div36">По убыванию</div>
            </div>
        ...
        <div class="line-div"></div>
        <div class="parent2">
          <div class="div35">Количеству выданных займов:</div>
          <div class="frame-parent12">
            <div class="radiobutton-parent">
              <div class="div36">По убыванию</div>
            </div>
        ...
        <div class="parent2">
          <div class="div35">По проценту не возврата:</div>
          <div class="frame-parent12">
            <div class="radiobutton-parent">
              <div class="div36">По убыванию</div>
            </div>
