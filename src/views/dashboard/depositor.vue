    ...
    <div class="tables-light-mode-parent">
      <div class="tables-light-mode">
        <div class="filter-2">
          ...
          <div class="sort" @click="toSort">(1)</div>
            ...
            <div class="frame-group">
              ...
              <div class="group">
                ...
                <div class="fields-password-and-mail-container">
                  ...
                  <div class="iconscalendar-wrapper" id="frameContainer3"></div>
                </div>
              </div>
            </div>
          </div>
...
const toSort = () => {
  router.push({ name: "dashboard-depositor-sort" });
};

const toggleSlide = (slideIndex: any) => {
  if (slideIndex === 0) {
    curentWindow.value = "Catos";
  } else if (slideIndex === 1) {
    curentWindow.value = "Ton";
  }
};
</script>
