  ...
  <modal from="setting">
    <div class="decor-parent">
      ...
      <p class="job-subtitle">
        Для автоматической работы настройте скрининг заявок на займы через API
      </p>
      <div class="decor"></div>
      <div class="fields-parent">
        <div class="frame-parent3">
          <div class="bg-wrapper">
            <img
              class="dash-lines"
              src="@/assets/images/dash-lines.png"
              alt=""
            />
            <img
              class="scrinning-image"
              src="@/assets/images/scrinning.svg"
              alt=""
            />
