    ...
    <div class="frame-parent3">
      <div class="fields-parent">
        <ul class="option-list">
          <li class="option">
            <label class="label">По одобренному кредиту:</label>
        ...
        <ul class="option-list_last option-list">
          <li class="option">
            <label class="label">Количеству выданных займов:</label>
            <ul class="option-item-list">
              <li class="option-item">
                <catos-checkbox variant="radiobutton"></catos-checkbox>
                <label class="option-label"> По возрастанию </label>
          ...
          <li class="option">
            <label class="label">По проценту на возврат:</label>
            <ul class="option-item-list">
              <li class="option-item">
                <catos-checkbox variant="radiobutton"></catos-checkbox>
                <label class="option-label"> По возрастанию </label>
