  ...
  <div class="frame-div">
    ...
    >
      <div class="desctopverpull-stats">
        ...
        />
        <div
          :class="role === 'collector' ? 'filtr6_collector filtr6' : 'filtr6'"
        >
          <div class="wrapper">
            <div class="div120">
              {{ role === "collector" ? "Задолженность №" : "пул №" }}
            ...
            <div class="statusbar-cards">
              ...
              <div class="frame-parent20">
                ...
                <div class="iconsbar-cards-parent">
                  ...
                  />
                  <div
                    v-if="poolByLoan?.free_period && role === 'collector'"
                    class="div123"
                  >
                    {{ parse(poolByLoan?.free_period).days }} дней = 0%
                  </div>
                  <div v-else class="div123">{{ freePeriodString }}</div>
                </div>
