    ...
    <div class="wrapper">
      <div class="pull-stats3">
        <div class="status-reg">
          <div class="parent10">
            <div class="div71">Займ #12456 продан</div>
          </div>
        </div>
        <div class="frame-parent23">
          <div class="frame-parent24">
            <div class="parent12_sold parent12">
              <div class="number">Статус:</div>
              <div class="alert-triangle-parent_sold alert-triangle-parent">
            ...
            <div class="percent-group">
              ...
              <div class="div83">
                ...
                <div class="div83_status_overdue div83_status div83">
                  (займ просрочен)
                </div>
              </div>
            </div>
            <div class="frame-wrapper2">
              <div class="frame-parent21">
                <div class="alert-triangle-parent">
                  ...
                  <div class="div84">Займ продан</div>
                </div>
                <div class="div24_sold div24">
                  Ваш долг был продан
                  <span> коллектору 000 Обязательства</span>. С вами свяжутся
                  представители этой организации для обсуждения вопросов
                  возврата долга
                </div>
              </div>
            </div>
