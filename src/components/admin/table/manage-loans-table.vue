<template>
  <div class="frame-parent-pulls-table">
    <div class="info-parent">
      <div class="info">
          ...
          <div class="buttons-tabs">
            <div class="iconsbar-cards-parent">
              ...
              <div class="txt1-parent">
                <div class="txt2">Займ на:</div>
                <div class="ton">450 000 TON</div>
              </div>
            </div>
        ...
        <div class="frame-container">
          <div class="frame-parent1">
            ...
            <div class="container">
              <div class="div7">Просрочен повторно</div>
            </div>
          </div>
          <div class="frame-child" />
          <div class="frame-parent1">
            <div class="wrapper">
              <div class="roi">Дата выдачи займа:</div>
            </div>
            <div class="container">
              <div class="div7">18.01.2022, 16:00</div>
            </div>
          </div>
          <div class="frame-child" />
          <div class="frame-parent1">
          ...
          <div class="frame-parent1">
            ...
            <div class="container">
              <div class="div7">13 512 TON</div>
            </div>
          </div>
          <div class="frame-child" />
          <div class="frame-parent1">
            <div class="wrapper">
              <div class="roi">Заявитель:</div>
            </div>
            <div class="container">
              <div class="div7_link div7">Иван Иванов</div>
            </div>
          </div>
          <div class="frame-child" />
          <div class="frame-parent1">
            <div class="wrapper">
              <div class="roi">Анкета заявителя:</div>
            </div>
            <div class="container">
              <div class="div7_link div7" @click="() => (isBlank = true)">
                Открыть
              </div>
            </div>
          </div>
      ...
      <div class="des-and-bbn">
        <div class="text-and-button">
          <div class="buttons-tabs2" @click="toDetail">
      ...
      <div class="filtr">
        <div class="wrapper7">
          <div class="div15">Займ #12345</div>
        </div>
      </div>
    </div>
  </div>
...
const toDetail = () => {
  router.push({ name: "manage-loans-detail" });
};
</script>
...
.info-parent {
  ...
  display: flex;
  flex-direction: column;
  padding: 1em 0.63em 1.25em;
  align-items: center;
  justify-content: flex-start;
  gap: 1em;
}
.frame-parent-pulls-table {
  position: relative;
