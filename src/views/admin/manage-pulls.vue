<template>
  <default-desktop-admin back>
    ...
    <template v-slot:tools>
      ...
      <tool-bar variant="manage-pulls"></tool-bar>
    </template>
    <template v-slot:body>
      <div class="rectangle-group_desktop rectangle-group">
        <!--<div class="group-item"></div>-->
        <div
          :class="activeIndex === 0 ? 'div8_active div8' : 'div8'"
          @click="
            () => {
              activeIndex = 0;
              currentUsers = 'new';
        ...
        <div
          :class="activeIndex === 1 ? 'div9_active div9' : 'div9'"
          @click="
            () => {
              activeIndex = 1;
              currentUsers = 'approved';
            }
          "
        >
          Одобренные
        ...
        <div
          :class="activeIndex === 2 ? 'div10_active div10' : 'div10'"
          @click="
            () => {
              activeIndex = 2;
              currentUsers = 'rejected';
            }
          "
        >
          Отклоненные
    ...
    <template v-slot:list>
      <ul>
        <li v-for="n in 6" :key="n">
          <pulls-admin-table :variant="currentUsers" :key="currentUsers">
          </pulls-admin-table>
        </li>
      </ul>
    </template>
...
import pullsAdminTable from "@/components/admin/desktop/pulls-admin-table.vue";
