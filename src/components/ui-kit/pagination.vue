      ...
      <template #prev-button>
        <span>
          ...
          >
            ...
            />
            <path
              d="M17.3594 14.5C17.5579 14.3015 17.8796 14.3015 18.0781 14.5L23.2188 19.6406C23.411 19.8416 23.411 20.1584 23.2188 20.3594L18.0781 25.5C17.8796 25.6985 17.5579 25.6985 17.3594 25.5C17.1609 25.3015 17.1609 24.9797 17.3594 24.7812L22.1406 20L17.3594 15.2187C17.1609 15.0203 17.1609 14.6985 17.3594 14.5Z"
              fill="#8181A5"
            />
          </svg>
        </span>
...
const limit = POOLS_PER_PAGE;
const onClickHandler = (page: number) => {
  poolListStore.setOffset(page * limit - limit);
};
...
.example-six .active-page::after {
  content: "";
  display: block;
  width: 30px;
  height: 3px;
  background-color: rgba(94, 129, 244, 1);
  border-radius: 6px;
  position: absolute;
  bottom: -13px;
  left: 3px;
