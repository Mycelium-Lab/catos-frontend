  ...
  <div class="pull-parent">
    <div class="pull">
              ...
              <div class="status-all-parent">
                <div class="status-all">
                  <div class="colors-graphsorders-parent">
                    ...
                    />
                    <div class="div">В ожидании одобрения</div>
                  </div>
                  <img
                    class="iconchange"
                    alt=""
            ...
            <div class="frame-parent">
              ...
              <div class="field-parent">
                <div class="field">
                  ...
                  <a class="div9" @click="() => (isBlank = true)">Открыть</a>
                </div>
                <div class="col-titles-bg" />
              </div>
              <div class="field-wrapper">
                <div class="field">
                  <div class="div2">Кошелек:</div>
                  <div class="jjjxxx812300">9jjjxxx...812300</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="filtr-wrapper">
        <div class="filtr">
          <div class="div11">Заявка #1223</div>
        </div>
      </div>
    </div>
  </div>
