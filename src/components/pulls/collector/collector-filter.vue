    ...
    <div class="frame-parent3">
      <div class="fields-parent">
        <ul class="option-list">
          ...
          <li>
            <label class="label">Текущему долгу:</label>
            <range-minmax-slider
              :max="10000"
          ...
          <li>
            <label class="label">Просроченных дней:</label>
            <range-minmax-slider
              :max="120"
          ...
          <li>
            <label class="label">Месту проживания:</label>
            <catos-select
              placeholder="Выберите место проживания"
              :options="options"
              :value="valuePlace"
              :optionWidth="87.7"
          ...
          <li>
            <label class="label">Стоимость займа:</label>
            <range-minmax-slider
              :max="10000"
...
const sliderMaxOverdue = ref(120);

const sliderMinCost = ref(0);
const sliderMaxCost = ref(10000);
